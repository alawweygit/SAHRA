...
(async () => {
  try {
    ...
    const langCard = await waitFor(() => $('.lang-card[data-lang="ar"]'), 'language picker');
    click(langCard);
    console.log('✔ language picker: chose Arabic');
    if (document.documentElement.dir !== 'rtl') throw new Error('RTL not applied after AR pick');
