...
const SHAPES = {
  ...
  interrogation:'[{"q":"You just bought a private island. What do you name it?"}]',
...
const GUIDANCE = {
  ...
  interrogation:'HOT-SEAT-STYLE PROMPTS, MODELED ON THE REAL PARTY GAME "HOT SEAT". Never use a [NAME] placeholder or third-person "What is X..." framing — every prompt speaks directly to the hot-seat player as "you", and the anonymous writers answer AS IF THEY WERE that person, pretending to be them. Good examples (style only, invent new ones, don\'t reuse verbatim): "You just bought a private island. What do you name it?", "What\'s the strangest thing in your fridge right now?", "You just got fired. What did you probably do?". SIMPLE AND SHORT: under 15 words, plain everyday vocabulary a 12-year-old would understand, one single clear question — no compound or multi-part prompts. BUILT FOR FUNNY MADE-UP ANSWERS: the prompt should invite a short, silly, invented answer that anyone could improvise in the target\'s voice — not something requiring real personal knowledge of them. Every prompt should work for literally any player without needing to know anything true about them. Keep it light, playful, and party-appropriate — funny and a little cheeky is great, but never sexual, offensive, or mean-spirited enough to actually embarrass someone.',
...
function isValidPrompt(mode, item, region) {
  ...
  switch (mode) {
    ...
    case 'interrogation': return text('q');
