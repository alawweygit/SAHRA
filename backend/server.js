...
const SHAPES = {
  ...
  interrogation:'[{"q":"[NAME] just bought a private island. What do they name it?"}]',
  ...
  '2t1l':       '[{"cat":"ABOUT YOU","emoji":"🤥","q":"What are 3 foods you could eat every single day?"}]',
...
const GUIDANCE = {
  ...
  interrogation:'HOT-SEAT-STYLE PROMPTS, MODELED ON THE REAL PARTY GAME "HOT SEAT". Every prompt MUST include the exact placeholder [NAME] naturally, referring to the hot-seat player by name, not "you" — the anonymous writers answer AS IF THEY WERE that person, pretending to be them, so the prompt describes a situation happening TO [NAME] and asks what [NAME] would do/say/name/have. Good examples (style only, invent new ones, don\'t reuse verbatim): "[NAME] just bought a private island. What do they name it?", "What\'s the strangest thing in [NAME]\'s fridge right now?", "[NAME] just got fired. What did they probably do?". SIMPLE AND SHORT: under 15 words, plain everyday vocabulary a 12-year-old would understand, one single clear question — no compound or multi-part prompts. BUILT FOR FUNNY MADE-UP ANSWERS: the prompt should invite a short, silly, invented answer that anyone could improvise in the target\'s voice — not something requiring real personal knowledge of them. Every prompt should work for literally any player without needing to know anything true about them. Keep it light, playful, and party-appropriate — funny and a little cheeky is great, but never sexual, offensive, or mean-spirited enough to actually embarrass someone.',
  ...
  '2t1l':       'Short personal category prompts that let one player write exactly two truths and one lie. Ask them to name 3 related things. Include a fitting emoji. EASY TO ANSWER: keep the category broad and instantly answerable — anyone should be able to think of 3 items in a few seconds without carefully filtering their memory. AVOID narrow qualifiers or specific conditions that turn it into a hard recall task (e.g. "movies you have watched more than twice", "books you read last year", "restaurants you\'ve been to more than 3 times") — these force the player to search their memory carefully instead of just answering. PUNCHY PHRASING: vary the sentence structure instead of always starting with "Name 3..." — mix in "What are 3...?", "3 ... ?", "If you could...", "Where are 3...?" for more energy and personality. STORY-INVITING THEMES: favor categories that naturally invite a small surprising story or confession over flat preference lists — travel mishaps, weird food combos or regrets, quirky/useless talents, random encounters or coincidences, embarrassing moments, weird habits, things that scare you, things you broke or lost. These produce far more interesting truths and lies than generic "things you like" categories. GOOD EXAMPLES (style only, invent new ones each time, don\'t reuse verbatim): "What are 3 foods you could eat every single day?", "Where are 3 places you\'re dying to visit?", "3 movies you could watch on repeat forever?", "3 things you\'re honestly terrible at?", "If you could live anywhere, name 3 places", "3 hobbies that actually make you happy?", "Name 3 things that have gone wrong while traveling", "Name 3 weird foods you\'ve tried in another country", "Name 3 random things you\'re surprisingly good at", "Name 3 useless talents you have", "Name 3 famous people you\'ve been near", "Name 3 coincidences that have happened to you", "Name 3 weird food combos you actually enjoy", "Name 3 foods you\'ve eaten that you regretted", "3 things you\'ve said you\'d never do (but did)?", "What are 3 nicknames you\'ve had?", "3 things you\'d grab in a house fire?", "What are 3 embarrassing songs you know every word to?", "3 things you\'ve lost and never found?", "What are 3 weird habits you have?", "3 things that scare you way more than they should?". Keep the wording itself short and simple — plain everyday words, no complex phrasing.',
  ...
  blendin:      'PUSH-THE-BUTTON-STYLE SOCIAL WRITING PROMPTS, NEVER TRIVIA. Each object contains two short, closely related everyday prompts: "a" goes to most players and "b" goes to one odd player. THREE-TIER STRUCTURE PER BATCH OF 3 (follow this exact order — position matters): PAIR 1 = NEUTRAL/PRACTICAL. Ordinary everyday things (packing, routines, places, objects). This is deliberately the safest, most answer-overlapping tier — the point is maximum overlap so the odd player is genuinely hardest to catch on the very first round. Example: "Something you\'d pack for school" / "Something you\'d pack for work". PAIR 2 = FUNNY/EMBARRASSING. Silly confessions, white lies, guilty pleasures, awkward habits — invites answers people laugh at when comparing out loud. Example: "A lie you\'d tell to get out of work" / "A lie you\'d tell to get out of a date". PAIR 3 = ROTATE THROUGH ONE OF THESE SIX FLAVORS EACH TIME (pick a different one across different batches/games, don\'t default to the same flavor every time — this is the memorable closer, the one people are still talking about after): (a) WHOLESOME/SENTIMENTAL — "Something that makes you feel loved" / "Something that makes you feel proud"; (b) PETTY/DRAMATIC — small grudges and minor beefs — "Something that annoys you about roommates" / "Something that annoys you about coworkers"; (c) NOSTALGIC/CHILDHOOD — "Something you were obsessed with as a kid" / "Something you were embarrassed by as a teenager"; (d) CHAOTIC/ABSURD — imaginative, surreal, less personal — "Something you\'d bring to survive a zombie apocalypse" / "Something you\'d bring to survive a boring wedding"; (e) HIGH-STAKES CONFESSION — bigger, more vulnerable than pair 2\'s silly lies — "Something you\'d want to change about yourself" / "Something you\'d want to change about your best friend"; (f) JUICY/PERSONAL — secrets and relationship drama, the gossipy one — "A red flag you\'ve ignored in a relationship" / "A red flag you\'ve ignored in a friendship". Whichever of the six you pick for pair 3, it should read as the most emotionally engaging or attention-grabbing of the three pairs, since it closes the round. THE REAL TEST IS ANSWER OVERLAP, NOT WORDING SIMILARITY: what matters is not how many words differ between "a" and "b" — it is whether a typical honest answer to "a" could also pass as a normal answer to "b", and vice versa, often enough that the odd player\'s answer doesn\'t immediately stick out. Before finalizing a pair, mentally answer both prompts yourself: if the two answer-spaces feel completely disconnected (nothing you\'d say to one makes sense for the other), the pair has failed even if the wording only changed slightly — and conversely, a pair can survive a bigger conceptual jump as long as the actual answers still plausibly overlap. Bad pair (looks like a small wording change, but answers never overlap): "Something you say to your mom" / "Something you say to your boss" — almost nothing a normal person says to their mother ("love you", "I\'m hungry") would ever be said to a boss, so the odd one out is instantly obvious even though only one word changed. Every person must understand both prompts instantly without needing factual, scientific, historical, sports, geographic, celebrity, or specialist knowledge. NEVER ask for a correct fact. NEVER use a question mark. NEVER begin with What, Which, Who, Where, When, How many, Name the, or their Arabic trivia equivalents. Keep each prompt under 12 words, natural, concrete, social, and party-appropriate — funny, cheeky, or emotionally engaging is great, but stay clear of anything sexual, offensive, or humiliating toward a protected group. Do not copy the examples verbatim; invent fresh pairs within each tier, always checking the answer-overlap test above before finalizing.',
