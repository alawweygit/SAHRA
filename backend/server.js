...
const GUIDANCE = {
  ...
  blendin:      'PUSH-THE-BUTTON-STYLE SOCIAL WRITING PROMPTS, NEVER TRIVIA. Each object contains two short, closely related everyday prompts: "a" goes to most players and "b" goes to one odd player. MAKE IT FUNNY: lean into prompts that invite silly, embarrassing, or absurd answers rather than flat, boring ones — "something you\'d never admit to your mom" beats "something you keep in a drawer". Funny doesn\'t mean the prompt itself has to be a joke; it means the ANSWER SPACE should naturally produce funny, relatable, or slightly cringe answers once players start reading them out loud and discussing. Think of the reveal moment as the punchline: players compare four honest answers to what looks like the same prompt, and the fun comes from spotting the one that\'s subtly off, or from everyone\'s answers being weirdly similar/different in an amusing way. THE REAL TEST IS ANSWER OVERLAP, NOT WORDING SIMILARITY: what matters is not how many words differ between "a" and "b" — it is whether a typical honest answer to "a" could also pass as a normal answer to "b", and vice versa, often enough that the odd player\'s answer doesn\'t immediately stick out. Before finalizing a pair, mentally answer both prompts yourself: if the two answer-spaces feel completely disconnected (nothing you\'d say to one makes sense for the other), the pair has failed even if the wording only changed slightly — and conversely, a pair can survive a bigger conceptual jump as long as the actual answers still plausibly overlap. Good pair (funny, different concepts, but real answers overlap heavily): "Something you\'d lie about to impress a date" / "Something you\'d lie about to impress your boss" — height, salary, hobbies, how much you work out could honestly answer either one, and the answers themselves tend to be funny confessions. Bad pair (looks like a small wording change, but answers never overlap): "Something you say to your mom" / "Something you say to your boss" — almost nothing a normal person says to their mother ("love you", "I\'m hungry") would ever be said to a boss, so the odd one out is instantly obvious even though only one word changed. ESCALATING DIFFICULTY ACROSS A BATCH: mirror the real game\'s pacing — make the FIRST pair in a batch the closest, most-overlapping pair (hardest to spot the odd player), and let LATER pairs in the same batch diverge a bit more (still connected, but a little easier to catch), building suspicion as the round progresses rather than every pair being equally obvious or equally subtle. Every person must understand both prompts instantly without needing factual, scientific, historical, sports, geographic, celebrity, or specialist knowledge. NEVER ask for a correct fact. NEVER use a question mark. NEVER begin with What, Which, Who, Where, When, How many, Name the, or their Arabic trivia equivalents. Keep each prompt under 12 words, natural, concrete, social, and party-appropriate — funny and a little cheeky is great, but stay clear of anything sexual, offensive, or humiliating toward a protected group. Do not copy the examples verbatim; invent fresh, funny pairs leaning into embarrassing moments, white lies, weird habits, dating/relationships, guilty pleasures, and awkward social situations, always checking the answer-overlap test above before finalizing.',
