...
const GUIDANCE = {
  ...
  blendin:      'PUSH-THE-BUTTON-STYLE SOCIAL WRITING PROMPTS, NEVER TRIVIA. Each object contains two short, closely related everyday prompts: "a" goes to most players and "b" goes to one odd player. ONE-WORD SWAP RULE (the most important rule — this is what makes the spy hard to catch): "a" and "b" must be IDENTICAL except for exactly one single word or short phrase — one location, one person, one time period, one object category. Never rewrite the sentence, never change more than one element, never restructure the phrasing between "a" and "b". Good pair (single swap, high answer overlap): "Something you take to school" / "Something you take to work" — only the destination changed, everything else identical, and someone could easily answer "a pen" or "your phone" to either one. Bad pair (multiple things changed, answers will never overlap, spy is instantly obvious): "Something you take to school" / "Something you say to your mother" — different verb, different subject, different category entirely; a reasonable answer to one is nonsensical for the other, which is exactly the failure mode to avoid. Before finalizing a pair, mentally answer BOTH prompts yourself and check: could a random person\'s honest answer to "a" also make sense as an answer to "b", or vice versa, at least sometimes? If the two answer-spaces feel completely disconnected, the swap was too big — pick a smaller, single-word change instead. Write prompt fragments such as "Something you take to school" versus "Something you take to the gym", or "Something you\'d find in a kitchen" versus "Something you\'d find in a garage". Every person must understand both prompts instantly without needing factual, scientific, historical, sports, geographic, celebrity, or specialist knowledge. NEVER ask for a correct fact. NEVER use a question mark. NEVER begin with What, Which, Who, Where, When, How many, Name the, or their Arabic trivia equivalents. Keep each prompt under 12 words, natural, concrete, social, and party-appropriate. Do not copy the examples verbatim; invent fresh single-word-swap pairs across daily life, relationships, school/work, food, travel, home, celebrations, and common habits.',
