...
const I18N = {
  en: {
    ...
    mode_taglines: {
      ...
      trueorlie: 'Spot the lie. Score the truth.',
      flaghunt: 'Name that flag. Speed wins.',
      ...
      emojiplace: 'Which place do the emojis show?',
    },
    mode_rules: {
      ...
      flaghunt: 'A flag emoji appears. Pick the correct country from 4 options. Fastest correct answer wins.',
      ...
      emojiplace: 'Emojis represent a place in the world. Identify it from 4 options. Speed matters.',
  ...
  ar: {
    ...
    mode_taglines: {
      ...
      trueorlie: 'اكتشف الكذبة. سجّل النقاط.',
      flaghunt: 'عرّف العلم. الأسرع يفوز.',
      ...
      emojiplace: 'الإيموجي يمثل مكان — أين هو؟',
    },
    mode_rules: {
      ...
      flaghunt: 'يظهر علم. اختر الدولة الصحيحة من ٤ خيارات. الأسرع في الإجابة الصحيحة يفوز.',
      ...
      emojiplace: 'إيموجيات تمثل مكان. حدده من ٤ خيارات. الأسرع يفوز.',
