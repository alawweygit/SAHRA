...
const I18N = {
  en: {
    ...
    write_lie: 'Write a convincing LIE (one word)',
    ...
    mode_taglines: {
      ...
      blendin: 'One of you answered a different prompt.',
    ...
    mode_rules: {
      ...
      blendin: 'Everyone gets the same everyday prompt except one secret player, who gets a closely related prompt. Nobody knows who. Answer honestly, then compare answers and vote for who seemed off. No trivia and no points — just social deduction.',
  ...
  ar: {
    ...
    write_lie: 'اكتب كذبة مقنعة (كلمة واحدة)',
    predict: 'شنو بيختار؟',
    ...
    mode_taglines: {
      ...
      blendin: 'وحد منكم يجاوب على مهمة مختلفة.',
    ...
    mode_rules: {
      ...
      blendin: 'الكل ياخذ نفس المهمة اليومية إلا لاعب واحد سري ياخذ مهمة قريبة لكن مختلفة. محد يدري مين هو. جاوبوا بصراحة، وقارنوا الإجابات، وبعدين صوّتوا مين كان غريب. بدون معلومات عامة وبدون نقاط — بس نقاش وكشف.',
