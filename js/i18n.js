...
const I18N = {
  en: {
    ...
    mode_taglines: {
      ...
      emoji: 'Decode the emojis. Type the answer.',
    ...
    mode_rules: {
      ...
      spy: 'Everyone knows the secret word except the spy. Discuss, vote, catch the spy — or the spy wins by guessing the word!',
  ...
  ar: {
    ...
    mode_rules: {
      ...
      spy: 'الكل يعرف الكلمة السرية ما عدا الجاسوس. ناقشوا وصوّتوا — إذا اتمسك الجاسوس يقدر يفوز إذا خمّن الكلمة!',
