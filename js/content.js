...
PACKS.emoji = {
  en: [
    { e:'🌊🦉', options:['Seoul','Tokyo','Beijing','Bangkok'], correct:0 },
    { e:'2️⃣🅰️🔑', options:['Turkey','Tunisia','Tanzania','Thailand'], correct:0 },
    { e:'🅰️🌊🅰️', options:['Alaska','Arabia','Atlanta','Alabama'], correct:1 },
    { e:'🐝🅰️🌊🅱️', options:['Barbados','Bahrain','Bahamas','Belgium'], correct:1 },
    { e:'🌸🗻🍣', options:['Japan','China','Korea','Vietnam'], correct:0 },
    { e:'🦁❤️🌿', options:['Kenya','Tanzania','Ethiopia','Uganda'], correct:0 },
    { e:'🅰️🌱🅱️🔑', options:['Argentina','Arabia','Angola','Albania'], correct:0 },
    { e:'🍕🅱️🏛️', options:['Italy','Greece','Spain','Portugal'], correct:0 },
    { e:'🗼💋🍷', options:['France','Italy','Spain','Romania'], correct:0 },
    { e:'🌵🌮🎸', options:['Mexico','Spain','Colombia','Peru'], correct:0 },
    { e:'🍁🏒🐻', options:['Canada','Russia','Finland','Sweden'], correct:0 },
    { e:'🦘🌿☀️', options:['Australia','New Zealand','South Africa','Brazil'], correct:0 },
    { e:'🐫🔺⭐', options:['Egypt','Jordan','Morocco','Tunisia'], correct:0 },
    { e:'🌷🚲🧀', options:['Netherlands','Denmark','Belgium','Germany'], correct:0 },
    { e:'☘️🍺🎶', options:['Ireland','Scotland','England','Wales'], correct:0 },
    { e:'🧊🌋♨️', options:['Iceland','Greenland','Norway','Finland'], correct:0 },
  ],
  ar: [
    { e:'🌊🦉', options:['سيول','طوكيو','بكين','بانكوك'], correct:0 },
    { e:'2️⃣🅰️🔑', options:['تركيا','تونس','تنزانيا','تايلاند'], correct:0 },
    { e:'🌸🗻🍣', options:['اليابان','الصين','كوريا','فيتنام'], correct:0 },
    { e:'🦁❤️🌿', options:['كينيا','تنزانيا','إثيوبيا','أوغندا'], correct:0 },
    { e:'🍕🅱️🏛️', options:['إيطاليا','اليونان','إسبانيا','البرتغال'], correct:0 },
    { e:'🗼💋🍷', options:['فرنسا','إيطاليا','إسبانيا','رومانيا'], correct:0 },
    { e:'🌵🌮🎸', options:['المكسيك','إسبانيا','كولومبيا','بيرو'], correct:0 },
    { e:'🍁🏒🐻', options:['كندا','روسيا','فنلندا','السويد'], correct:0 },
    { e:'🦘🌿☀️', options:['أستراليا','نيوزيلندا','جنوب أفريقيا','البرازيل'], correct:0 },
    { e:'🐫🔺⭐', options:['مصر','الأردن','المغرب','تونس'], correct:0 },
    { e:'🌷🚲🧀', options:['هولندا','الدنمارك','بلجيكا','ألمانيا'], correct:0 },
    { e:'☘️🍺🎶', options:['أيرلندا','اسكتلندا','إنجلترا','ويلز'], correct:0 },
    { e:'🧊🌋♨️', options:['آيسلندا','جرينلاند','النرويج','فنلندا'], correct:0 },
    { e:'🅰️🌱🅱️🔑', options:['الأرجنتين','العربية','أنغولا','ألبانيا'], correct:0 },
    { e:'🐝🅰️🌊🅱️', options:['بربادوس','البحرين','الباهاما','بلجيكا'], correct:1 },
    { e:'🌊🦉🍣🏯', options:['كوريا الجنوبية','اليابان','الصين','تايوان'], correct:0 },
  ],
};
