...
PACKS.emoji = {
  en: [
    { e:'🦁👑🌿', options:['The Lion King','Tarzan','Jungle Book','Black Panther'], correct:0 },
    { e:'🧊❄️👸', options:['Frozen','Cinderella','Snow White','Brave'], correct:0 },
    { e:'🕷️♂️🏙️', options:['Spider-Man','Batman','Superman','Iron Man'], correct:0 },
    { e:'⚡🧙🏫', options:['Harry Potter','The Witcher','Merlin','Percy Jackson'], correct:0 },
    { e:'🐠🐟🌊🔍', options:['Finding Nemo','The Little Mermaid','Jaws','Free Willy'], correct:0 },
    { e:'🚗⚡🏎️', options:['Lightning McQueen','Fast and Furious','Turbo','Cars'], correct:3 },
    { e:'👨‍🍳🐭🍽️', options:['Ratatouille','Chef','MasterChef','Julie and Julia'], correct:0 },
    { e:'🌹💔🚢', options:['Titanic','Romeo and Juliet','The Notebook','Twilight'], correct:0 },
    { e:'👴⬆️🏠🎈', options:['Up','Home Alone','The Balloon','The Grandpa'], correct:0 },
    { e:'🐻🍯🌲', options:['Winnie the Pooh','Paddington','Brother Bear','Brave'], correct:0 },
    { e:'🔫🕶️💼', options:['James Bond','Mission Impossible','John Wick','The Equalizer'], correct:0 },
    { e:'🤖👾🚀🌌', options:['Star Wars','Transformers','Avengers','WALL-E'], correct:0 },
    { e:'🧱🐷💨', options:['Three Little Pigs','Big Bad Wolf','Peppa Pig','Charlotte Web'], correct:0 },
    { e:'🍫🏭👨‍👧', options:['Charlie and the Chocolate Factory','Ratatouille','Matilda','The BFG'], correct:0 },
    { e:'🧟🧠🌍', options:['The Walking Dead','Zombieland','World War Z','28 Days Later'], correct:0 },
    { e:'🌀🦸🌊', options:['Aquaman','Moana','Atlantis','Waterworld'], correct:1 },
  ],
  ar: [
    { e:'🦁👑🌿', options:['الأسد الملك','طرزان','كتاب الأدغال','الفهد الأسود'], correct:0 },
    { e:'🧊❄️👸', options:['فروزن','سندريلا','بياض الثلج','شجاعة'], correct:0 },
    { e:'🕷️♂️🏙️', options:['سبايدرمان','باتمان','سوبرمان','آيرون مان'], correct:0 },
    { e:'⚡🧙🏫', options:['هاري بوتر','ذا ويتشر','ميرلين','بيرسي جاكسون'], correct:0 },
    { e:'🐠🐟🌊🔍', options:['البحث عن نيمو','حورية البحر','أفواه القرش','حوت حر'], correct:0 },
    { e:'🚗⚡🏎️', options:['لايتنينج ماكوين','السريع والغاضب','تيربو','سيارات'], correct:3 },
    { e:'👨‍🍳🐭🍽️', options:['راتاتوي','الطاهي','ماستر شيف','جولي وجوليا'], correct:0 },
    { e:'🌹💔🚢', options:['تيتانيك','روميو وجولييت','دفتر الذكريات','توايلايت'], correct:0 },
    { e:'👴⬆️🏠🎈', options:['علياء','وحيدًا في المنزل','البالون','الجد'], correct:0 },
    { e:'🐻🍯🌲', options:['ويني ذا بو','بادينغتون','الدب الأخ','شجاعة'], correct:0 },
    { e:'🔫🕶️💼', options:['جيمس بوند','مهمة مستحيلة','جون ويك','المعادل'], correct:0 },
    { e:'🤖👾🚀🌌', options:['حرب النجوم','المحولون','أفنجرز','وول-إي'], correct:0 },
    { e:'🧱🐷💨', options:['الخنازير الثلاثة','الذئب الكبير','بيبا بيج','شارلوت'], correct:0 },
    { e:'🍫🏭👨‍👧', options:['تشارلي والمصنع','راتاتوي','ماتيلدا','الصديق العملاق'], correct:0 },
    { e:'🧟🧠🌍', options:['ذا ووكينج ديد','زومبيلاند','حرب العالم Z','28 يومًا'], correct:0 },
    { e:'🌀🦸🌊', options:['أكوامان','موانا','أتلانتس','ووترورلد'], correct:1 },
  ],
};
